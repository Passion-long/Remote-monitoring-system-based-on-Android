...
public class trendcurve extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trendcurve);
...
//                //跳转到btn演示界面
//                Intent intent1=new Intent(trendcurve.this,trendreal_chooseinf.class);
...
//            public void onClick(View view) {
//                //跳转到btn演示界面
//                Intent intent=new Intent(trendcurve.this,trendreal_choosecon.class);
...
//            public void onClick(View view) {
//                //跳转到btn演示界面
//                Intent intent=new Intent(trendcurve.this,historytrend.class);
//                startActivity(intent);
//            }
//        });

//
//        final LineChart mChart = (LineChart) findViewById(R.id.real_chart0);
//        initialChart(mChart);
